...
<div class="navbar" id="navbarid">
    ...
    <a href=""><img id="logo" src="../../Image/logo/freelance.jpg" alt="ss"></a>
    ...
    <a class="" href="profile.php" id="profile"><div class="pimge" style="background-image: url(UploadImage/<?php echo $_SESSION['image'];?>);"></div> <u><?php echo $_SESSION['fName']; ?></u></a>
