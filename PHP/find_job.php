...
<body>
    <header>
        ...
        <div class="headerbar" style="background-color: #f8ea6b78; height: 40px;">
            <h5 style="  padding: 5px;text-align: center; font-size: 20px;">Please login for see more jobs</h5>
        </div>
    </header>
